...
if registrarse_o_iniciarsesion=="1":
  interfaz_inicio_sesion = InterfazSesion() # Se crea una instancia de la clase interfaz
  ...
  inicio_sesion = InicioSesion(usuario, contrasena)

#Para regiustrarse
if registrarse_o_iniciarsesion=="2":
  interfaz_registro_usuario = InterfazSesion() # Se crea una instancia de la clase interfaz
  usuario = interfaz_registro_usuario.usuario
  contrasena = interfaz_registro_usuario.contrasena
  # Se crea una instancia de la clase InicioSesion con los datos ingresados por el usuario en interfaz.py
  registro_usuario = RegistroUsuario(usuario, contrasena)
  print(credenciales)
